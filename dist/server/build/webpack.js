...
exports.default = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(dir) {
    ...
    var config, defaultEntries, mainJS, _minChunks, entry, plugins, nodePathList, mainBabelOptions, externalBabelConfig, options, rules, webpackConfig;
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            webpackConfig = {
              ...
              entry: entry,
              output: {
                path: (0, _path.join)(buildDir || dir, '.next'),
                filename: '[name]',
